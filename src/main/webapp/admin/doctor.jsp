                	...
                	<div class="card-body">
                		...
                		<form action="../addDoctor" method="post" enctype="multipart/form-data">
                			...
                			<div class="mb-3">
                				...
                				<input type="text" name="mobno" class="form-control" placeholder="Enter mobile number" required>
                			</div>
                			...
                			<div class="mb-3">
                				<label class="form-label"><i class="fa-solid fa-image"></i> Photo</label>
                				<input type="file" name="photo" class="form-control" accept="image/*">
                			</div>
                			
                			<button type="submit" class="btn btn-primary col-md-12"><i class="fa-solid fa-user-plus me-2"></i>Add Doctor</button>
                		</form>
                	</div>
                </div>
			</div>
