...
<title>Admin Login - Medi Home</title>
...
<body>
	...
	<%-- 
	Note: This includes the main navbar from component folder, NOT the admin-specific navbar
	The admin navbar has session checks that would cause redirect loops on the login page
	--%>
   		...
   		<div class="row">
            <div class="col-md-4 offset-md-4">
                <div class="card paint-card">
                    <div class="card-body">
                    	<p class="fs-3 fw-semibold text-center">Admin Login</p>
                        ...
                        <form action="adminLogin" method="post">
                            ...
                            <button type="submit" class="btn btn-custom col-md-12"><i class="fa-solid fa-shield-halved me-2"></i>Admin Login</button>
                       </form>
